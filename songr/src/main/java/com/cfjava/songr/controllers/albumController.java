...
@GetMapping("/albums")
    ...
    public RedirectView addAlbumFromForm(long id, String title, String artist, Integer songCount, Integer length) {
        ...
        Album newAlbum = new Album(id, title, artist, songCount, length, imageURL);
